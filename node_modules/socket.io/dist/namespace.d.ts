import { Socket } from "socket.io/dist/socketo/dist/socket";
import type { Server } from "socket.ioio";
import { EventParams, EventNames, EventsMap, StrictEventEmitter, DefaultEventsMap, DecorateAcknowledgementsWithTimeoutAndMultipleResponses, AllButLast, Last, DecorateAcknowledgementsWithMultipleResponses, DecorateAcknowledgements, RemoveAcknowledgements, EventNamesWithAck, FirstNonErrorArg, EventNamesWithoutAck } from "socket.io/dist/typed-events/typed-events";
import type { Client } from "socket.io/dist/cliento/dist/client";
import type { Adapter, Room, SocketId } from "socket.io-adapter";
import { BroadcastOperator } from "socket.io/dist/broadcast-operatorcast-operator";
...
export declare class Namespace<ListenEvents extends EventsMap = DefaultEventsMap, EmitEvents extends EventsMap = ListenEvents, ServerSideEvents extends EventsMap = DefaultEventsMap, SocketData = any> extends StrictEventEmitter<ServerSideEvents, RemoveAcknowledgements<EmitEvents>, NamespaceReservedEventsMap<ListenEvents, EmitEvents, ServerSideEvents, SocketData>> {
     ...
     * }
     */
    fetchSockets(): Promise<import("socket.io/dist/broadcast-operatorcast-operator").RemoteSocket<EmitEvents, SocketData>[]>;
    /**
